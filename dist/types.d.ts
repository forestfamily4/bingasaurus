...
type BotMessageType = "InternalSearchQuery" | "Context" | "InternalSearchResult" | "InternalLoaderMessage" | "RenderCardRequest" | "Disengaged";
...
export interface QueryMessage extends Omit<BaseMessage, "createdAt" | "messageId" | "offense" | "adaptiveCards" | "sourceAttributions" | "feedback" | "contentOrigin" | "privacy"> {
    locale: string;
    market: string;
    region?: string;
    location?: string;
...
export type BotMessage = RenderCardRequest | InternalLoaderMessage | InternalSearchQuery | InternalSearchResult | DisengagedMessage;
type Message = ResponseMessage | RenderCardRequest | InternalLoaderMessage | InternalSearchQuery | UserMessage | InternalSearchResult;
...
export type BingMessageOptions = Partial<SydneyQueryOptions> | Partial<ChatRequestHubOptions>;
...
export type SydneyServerMessage = MessageType1 | MessageType2 | MessageType3 | MessageType6 | MessageType7;
export declare enum ChatHubStatus {
    DELIVERED = "delivered",
    FAILED = "failed",
    FINISHED = "finished",
    PENDING = "pending",
